...
<Playground>
  {() => {
    ...
    return (
      <div className='playground-style' style={{height: '200px', alignItems: 'flex-start'}}>
...
<Playground>
  {() => {
    ...
    return (
      <div className='playground-style' style={{height: '300px', alignItems: 'flex-start'}}>
        <div
          style={{
            display: 'flex',
...
<Playground>
  {() => {
    ...
    return (
      <div className='playground-style' style={{height: '400px', width: '100%', margin: 'auto'}}>
        <div
          ref={containerRef}
          style={{
            height: '250px',
